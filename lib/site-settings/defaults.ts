...
export const SITE_SETTINGS_DEFAULTS: Record<string, string> = {
  ...
  [SITE_SETTING_KEYS.META_TITLE]: DEFAULT_SITE_TITLE,
  [SITE_SETTING_KEYS.META_DESCRIPTION]: DEFAULT_SITE_DESCRIPTION,
  [SITE_SETTING_KEYS.META_KEYWORDS]: DEFAULT_KEYWORDS,
  ...
  [SITE_SETTING_KEYS.OG_TYPE]: "website",

  [SITE_SETTING_KEYS.TWITTER_TITLE]: DEFAULT_OG_TITLE,
  [SITE_SETTING_KEYS.TWITTER_DESCRIPTION]: DEFAULT_OG_DESCRIPTION,
  [SITE_SETTING_KEYS.TWITTER_IMAGE]: "",
  [SITE_SETTING_KEYS.TWITTER_CARD]: "summary_large_image",
